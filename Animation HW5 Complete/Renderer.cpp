...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	//Place Holders for widget window
	gui_1->addVariable("Target X:", m_bone_animation->rotation_degree_vector[1][0]);
	gui_1->addVariable("Target Y:", m_bone_animation->rotation_degree_vector[1][0]);
	gui_1->addVariable("Target Z:", m_bone_animation->rotation_degree_vector[1][0]);
	gui_1->addVariable("Current end pos X:", m_bone_animation->rotation_degree_vector[1][0]);
	gui_1->addVariable("Current end pos Y:", m_bone_animation->rotation_degree_vector[1][0]);
	gui_1->addVariable("Current end pos Z:", m_bone_animation->rotation_degree_vector[1][0]);
